...
from ipal_iids.ids.ids import MetaIDS
...
class InterArrivalTimeRange(MetaIDS):
    ...
    _interarrivaltimerange_default_settings = {"N": 4, "W": 5}
    ...
    def __init__(self, args, name=None):
        ...
        if args.lin17_range_n:
            self.settings["N"] = int(args.lin17_range_n)
        if args.lin17_range_w:
            self.settings["W"] = int(args.lin17_range_w)
