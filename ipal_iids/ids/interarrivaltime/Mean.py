...
class InterArrivalTimeMean(MetaIDS):
    ...
    _interarrivaltimemean_default_settings = {"N": 4, "W": 5}
    ...
    def __init__(self, args, name=None):
        ...
        if args.lin17_mean_n:
            self.settings["N"] = int(args.lin17_mean_n)
        if args.lin17_mean_w:
            self.settings["W"] = int(args.lin17_mean_w)
